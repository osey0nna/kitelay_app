<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <h2 class="text-xl md:text-2xl font-bold text-white">Kelola Kriteria</h2>
    ...
    <div class="bg-black py-6 md:py-10">
        <div class="mx-auto flex max-w-7xl flex-col gap-6 px-4 md:px-6 lg:px-8">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-neutral-800 text-sm">
                        <thead class="bg-[#050505] text-left text-xs font-bold uppercase tracking-[0.18em] text-slate-400">
                            <tr>
                                <th class="px-4 md:px-6 py-2 md:py-4">Urutan</th>
                                <th class="px-4 md:px-6 py-2 md:py-4">Kriteria</th>
                                <th class="px-4 md:px-6 py-2 md:py-4">Bobot</th>
                                <th class="px-4 md:px-6 py-2 md:py-4 text-right">Aksi</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-neutral-800 bg-[#0a0a0c] text-slate-200">
                            @forelse ($kriterias as $kriteria)
                                <tr class="hover:bg-[#050505] transition-colors">
                                    <td class="px-4 md:px-6 py-3 md:py-5 align-top font-bold text-white">{{ $kriteria->urutan }}</td>
                                    <td class="px-4 md:px-6 py-3 md:py-5 align-top">
                                    ...
                                    <td class="px-4 md:px-6 py-3 md:py-5 align-top font-semibold text-white">{{ $kriteria->bobot }}</td>
                                    <td class="px-4 md:px-6 py-3 md:py-5 align-top">
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-4 md:px-6 py-8 md:py-12 text-center text-sm text-slate-400">
