<div class="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
    ...
    <div class="space-y-5 rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <div class="rounded-2xl bg-slate-50 p-5 text-sm leading-7 text-slate-600">
            <p class="font-bold text-slate-900">Tips Pengaturan Bobot</p>
...
<div class="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    <a href="{{ route('admin.perlombaan.kriteria.index', $perlombaan) }}" class="inline-flex items-center justify-center rounded-2xl border border-slate-200 bg-white px-5 py-3 text-sm font-bold text-slate-700 transition hover:border-slate-300 hover:text-slate-950">
        Kembali
    </a>
