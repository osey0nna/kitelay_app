<x-app-layout>
    <x-slot name="header">
        <div>
            ...
            <h2 class="text-2xl md:text-3xl lg:text-4xl font-black tracking-[-0.04em] text-slate-950">Tambah User</h2>
            <p class="mt-1 max-w-2xl text-xs md:text-sm leading-7 text-slate-500">Buat akun baru untuk admin internal atau juri perlombaan.</p>
        </div>
    </x-slot>
